...
export const requireRefreshToken = (req, res, next) => {
  try {
    ...
    console.log("Clave secreta para verificar:", process.env.JWT_REFRESH_SECRET); // Para depuración
    const { use_id } = jwt.verify(refreshTokenCookie, process.env.JWT_REFRESH_SECRET);
    req.use_id = use_id;
    next();
    console.log("usuario",use_id)
